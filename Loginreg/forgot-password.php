        ...
        <div class="container"  >
            ...
            <div class="workinghny-form-grid">
                <div class="main-mockup">
                    <!-- <div class="alert-close" style="background:orange;color: black;"> 
                        <span class="fa fa-close"></span>
                    </div> -->
                    <div class="w3l_form align-self" style="background: no-repeat;">
                        <!-- <div class="left_grid_info">
                            <img src="images/image3.svg" alt="">
                        </div> -->
                    </div>
                    <div class="content-wthree" style="background: #000000; 
background: -webkit-linear-gradient(to right, #434343, #000000);  
background: linear-gradient(to right, #434343, #000000); 
">
                        <h2 style="color:white;">Forgot Password</h2>
                        <p>india is a good country in the world please visite here. </p>
                        <?php echo $msg; ?>
                        <form action="" method="post">
                            <input type="email" class="email" name="email" placeholder="Enter Your Email" required>
                            <button name="submit" class="btn" type="submit" style="background:blueviolet;">Send Reset Link</button>
                        </form>
