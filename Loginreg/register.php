...
<head>
    <title>Register - Read for speed</title>
    <!-- Meta tag Keywords -->
            ...
            <div class="workinghny-form-grid">
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        <h2>Sign UP  Now</h2>
                        <p> Sign up to enable exercise section </p>
                        <?php echo $msg; ?>
                        <form action="" method="post">
                            ...
                            <button name="submit" class="btn" type="submit" style="background:blueviolet;">Register</button>
                        </form>
